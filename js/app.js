    ...
    data.data.forEach((card)=> {
        ...
        <div class="card-body flex-row gap-3 flex-wrap">
          ...
          <div class="flex gap-6">
            <div>
                <h1 class="text-gray-500">${card.authors[0].profile_name}</h1>
                <h1 class="text-gray-500">${card.others.views} views</h1>
            </div>
            <h1>${card.authors[0].verified?`<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
